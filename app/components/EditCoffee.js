...
import { StyleSheet, Text, View, TextInput, Button, TouchableHighlight, ActivityIndicator, AsyncStorage, FlatList, Alert } from 'react-native';
...
export default class HomeView extends React.Component{
    ...
    async updateCoffee(){
        ...
        return await fetch(`${routes.api}api/edit-coffee?coffee=${this.state.id}&title=${this.state.title}&description=${this.state.description}`)
            .then((message) => {
    ...
    async deleteCoffee(){
        ...
        return await fetch(`${routes.api}api/delete-coffee?coffee=${this.state.id}`,
            {method: 'delete'})
            .then((message) => {
        ...
        return(
            <View
                ...
                <TextInput
                    ...
                    autoCapitalize="sentences"
                    onChangeText={(userNameText) => this.setState({description: userNameText})}
                />
                <TouchableHighlight
                    onPress={() => { this.updateCoffee() }}>
                    <View
