...
import { fetchShotsAndComments } from '../assets/apiTemp';
...
export default class App extends React.Component {
    ...
    getAllCoffees(){
        return fetch('https://ui-coffee-club-api.herokuapp.com/api/get-coffees')
            ...
            .then((coffeesJson) => {
                this.setState({shots: coffeesJson.coffees, loading: false});
    ...
    render() {
        ...
        return (
            <View style={{ paddingTop: 20, backgroundColor: '#ea4c89', width: 312, height: 600 }}>
                <Animated.View
                    style={{
